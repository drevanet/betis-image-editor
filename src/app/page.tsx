...
export default function HomePage() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Enhance image quality and resolution without losing clarity using cutting-edge technology.",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    },
    {
      ...
      description:
        "Intelligently crop images around specific objects with advanced detection and framing.",
    ...
    },
    {
      ...
      description:
        "Process images in seconds, not minutes. Our optimized Image Editing infrastructure delivers results instantly.",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Perfect for product photography. The Image upscaling feature makes my images look professional.",
      rating: 5,
    },
    {
      name: "Emma Rodriguez",
            ...
            <div className="mt-16 text-center">
              ...
              <div className="grid grid-cols-2 items-center justify-center gap-6 opacity-80 sm:grid-cols-5">
                <div className="text-center">
                  <div className="text-2xl font-bold text-slate-700">2K+</div>
                ...
                <div className="col-span-2 text-center sm:col-span-1">
                  ...
                  <div className="text-xs text-slate-500">Fast Processing</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description:
                  "Select from our powerful Editing tools: background removal, upscaling, or object-focused cropping.",
              },
              {
                step: "03",
      ...
      <section className="bg-gradient-to-r from-blue-100/70 to-purple-100/70 py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              Join thousands of creators using Betis Image Editor to enhance their visual
              content
            </p>
